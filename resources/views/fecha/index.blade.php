    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card p-2 mt-1 bg-gray-100">
                <div class="mx-auto">
                    <h3 class="font-bold text-2xl uppercase p-2 mb-1 text-gray-600">Listado Fechas PRE-Inscripciones a Turnos
                    </h3>
                </div>
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a href="{{ route('fecha.create') }}" class="btn btn-outline mx-auto">Crear
                                ciclo <i class="ml-2 fas fa-chevron-right"></i>
                            </a>
                        </div>
